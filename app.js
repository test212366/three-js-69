...
import fragmentShaderP from './shaders/fragment copy.glsl'
import vertexShaderP from './shaders/vertexParticles.glsl'
...
export default class Sketch {
	...
	addParticles() {
		this.materialP = new THREE.ShaderMaterial({
			extensions: {
		...
		this.geometryP.setAttribute('position', new THREE.BufferAttribute(positions,3))



		this.planeP = new THREE.Points(this.geometryP, this.materialP)
 
		this.scene.add(this.planeP)
	}
	settings() {
		let that = this
		this.settings = {
